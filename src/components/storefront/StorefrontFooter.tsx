      ...
      <div className="bg-gradient-to-b from-[#8C0034] via-[#75002C] to-[#5C0022]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-10">
            ...
            {/* Column 1: Brand Identity & About (Logo, Title & Description remain on mobile) */}
            <div className="lg:col-span-4 space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl overflow-hidden bg-white p-0.5 border border-white/30 shadow-md shrink-0">
                  <img
                    src={displayLogo}
                    alt={brandName}
              ...
              {/* Newsletter Subscription (Desktop only, hidden on mobile) */}
            ...
            {/* Column 2: Categories (Hidden on mobile, visible on tablet/desktop) */}
            ...
            {/* Column 3: Quick Services & Tools (Hidden on mobile, visible on tablet/desktop) */}
            ...
            {/* Column 4: Contact & Locations (Hidden on mobile, visible on tablet/desktop) */}
            <div className="hidden md:block lg:col-span-3 space-y-3">
              <h4 className="text-xs font-extrabold text-white uppercase tracking-wider">
                Head Office &amp; Contact
              </h4>
        ...
        <div className="border-t border-white/10 bg-black/30 py-4 sm:py-5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-xs text-rose-200/80 text-center sm:text-left">
            
            {/* All Rights Reserved Area (Preserved on all screen sizes) */}
            ...
            {/* Links and staff access (Hidden on mobile, visible on tablet/desktop) */}
