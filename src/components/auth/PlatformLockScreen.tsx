              ...
              <div className="space-y-3">
                ...
                {isDevOrSandbox && (
                  <button
                    ...
                    className="w-full py-2.5 px-4 bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-300 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-2 active:scale-98 shadow-2xs"
                  >
                ...
                {isDevOrSandbox && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      playSuccessSound();
                      setSuccessMessage('Welcome Accountant (Sandbox Preview)');
                    }}
                    className="w-full py-2.5 px-4 bg-emerald-50 hover:bg-emerald-100 text-emerald-900 border border-emerald-300 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-2 active:scale-98 shadow-2xs"
                  >
                    <Landmark className="w-4 h-4 text-emerald-700" />
                    <span>Dev Sandbox Quick Accountant Login</span>
                  </button>
                )}
